...
public class DetailPanel extends JPanel {
    ...
    private Board2 boardPanel;     // Board2 참조
    ...
    public DetailPanel() {
        ...
        btnModify.addActionListener(e -> {
            ...
            CRUD.updateBoard(boardNo, title, content); // 수정 메서드 호출            
        ...
        btnDelete.addActionListener(e -> {
            ...
            if (result == JOptionPane.YES_OPTION) {
                int boardNo = Integer.parseInt(board_no.getText());
                CRUD.deleteBoard(boardNo); // 삭제 메서드 호출
    ...
    public void setDetailPanel(Board2 boardPanel, JPanel detailPanel) {
